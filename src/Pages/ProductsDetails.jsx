...
const ProductsDetails = () => {
    ...
    return (
        <div className="p-4 md:p-12 bg-base-200 min-h-screen">
            <div className="max-w-7xl mx-auto bg-white rounded-xl shadow-2xl p-6 md:p-10">

                <h1 className="text-4xl font-extrabold text-center text-neutral mb-8">
                    {name} Details & Order
                </h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="border-b pb-4">
                            <div className={`badge ${isPet ? 'badge-error' : 'badge-info'} text-white font-semibold mb-2 text-lg p-3`}>
                                {category}
                            </div>
                            <p className="text-3xl font-bold text-secondary mt-2">
                                Price: {price === 0 ? (
                                    <span className="text-error">Free for Adoption</span>
                                ) : (
                                    `৳${price}`
                                )}
                            </p>
                            <p className="text-lg text-gray-600 mt-1">
                                <span className="font-semibold text-neutral">📍 Location:</span> {location}
                            </p>
                            <p className="text-sm text-gray-500 mt-1">
                                <span className="font-semibold text-neutral">👤 Owner/Seller Contact:</span> {email}
                            </p>
                        </div>
                    ...
                    <div className="lg:border-l lg:pl-10">
                        <h2 className="text-3xl font-bold text-primary mb-5">
                            {isPet ? "Adoption Request Form" : "Place Your Order"}
                        </h2>
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="form-control">
                                ...
                                <input type="text" placeholder='Your Name' className="input input-bordered bg-gray-100" />
                            </div>
                            <div className="form-control">
                            ...
                            <div className="form-control">
                                ...
                                <input
                                    type="text"
                                    value={price === 0 ? "Adoption (Free)" : `৳${price}`}
                                    readOnly
                            ...
                            <div className="form-control">
                                ...
                                <input
                                    type="number"
                                    defaultValue={isPet ? 1 : 1}
                                    min={isPet ? 1 : 1}
                                    max={isPet ? 1 : 99}
                                    readOnly={isPet}
                                    className={`input input-bordered ${isPet ? 'bg-gray-100' : ''}`}
                                    required
                                />
                            ...
                            {/* Required Fields */}
                            <div className="form-control sm:col-span-2 flex flex-col justify-center items-center">
                                <label className="label"><span className="label-text font-semibold mb-2">Delivery/Pickup Address</span></label>
                                <textarea placeholder="Your full address" className="textarea textarea-bordered h-20" required></textarea>
                            </div>
                            <div className="form-control">
                            ...
                            <div className="form-control">
                                ...
                                <input type="tel" placeholder="e.g., 01XXXXXXXXX" className="input input-bordered" required />
                            </div>

                            {/* Additional Notes */}
                            <div className="form-control sm:col-span-2 flex flex-col justify-center items-center">
                                <label className="label"><span className="label-text font-semibold mb-2">Additional Notes (Optional)</span></label>
                                <textarea placeholder="Any specific delivery instructions or pet requirements." className="textarea textarea-bordered h-20"></textarea>
                            </div>

                            {/* Submit Button */}
                            <div className="form-control mt-6 sm:col-span-2 flex items-center justify-center">
                                <button type="submit" className="btn btn-secondary text-lg">
                                    {isPet ? "Submit Adoption Request" : "Confirm Order"}
                                </button>
                            </div>
                        </form>
                    </div>
