        ...
        <div className="p-8 bg-base-200 min-h-screen container mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center bg-white p-4 rounded-lg shadow-md mb-8 gap-4">
                <div className="form-control w-full md:w-1/3">
                    <select className="select select-bordered select-md font-semibold">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {petsData.map(pet => {
                    ...
                    return (
                        <div key={_id} className="card bg-white shadow-xl hover:shadow-2xl transition-shadow duration-300">
